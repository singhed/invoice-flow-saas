...
export default async function InvoicesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="mb-2 text-4xl font-bold text-slate-100">Invoices</h1>
        <p className="text-slate-400">View and manage all your expenses and invoices</p>
      </div>
        ...
        <Card>
          <CardContent className="py-12">
            <div className="text-center">
              ...
              <h3 className="mb-2 text-xl font-semibold text-slate-200">Unable to Load Expenses</h3>
              <p className="mb-4 text-slate-400">{error}</p>
              <p className="text-sm text-slate-500">
                The expense API endpoints may not be implemented yet on the backend. This page is
                ready to display expenses once the backend endpoints are available.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="py-12">
            <div className="text-center">
              ...
              <h3 className="mb-2 text-xl font-semibold text-slate-200">No Expenses Found</h3>
              <p className="text-slate-400">
                You haven&apos;t created any expenses yet. Start by adding your first expense!
              </p>
            </div>
          </CardContent>
        </Card>
